        ...
        <div className="container mx-auto px-6 py-4 flex justify-between items-center max-w-6xl">
          <div className="flex items-center gap-3 group cursor-pointer">
            <div className="relative">
              ...
              <span className="absolute -top-1 -right-1 flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#BFA37A] opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#BFA37A]"></span>
              </span>
            </div>
            <span className="text-xl font-bold tracking-widest uppercase text-foreground font-serif">
              KAREN MENDEZ <span className="text-[#BFA37A] font-light font-sans font-normal">HAIR DESIGNER</span>
            </span>
          </div>
          <nav className="flex items-center gap-4">
            ...
            {isAdmin && (
              <Button 
                variant="outline" 
                className="border-[#BFA37A] text-[#BFA37A] hover:bg-[#BFA37A] hover:text-white font-light rounded-none tracking-widest text-xs px-4"
            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-4">
                <span className="text-xs text-[#8A8172] tracking-wider uppercase font-light hidden md:inline">
                  {user?.name}
                </span>
                <Button 
                  variant="ghost" 
                  className="text-[#8A8172] hover:text-[#1E1D1A] font-light text-xs tracking-wider"
                  onClick={logout}
                >
                  SALIR
                </Button>
        ...
        <>
              ...
              <div className="container mx-auto px-6 max-w-6xl w-full flex flex-col items-start text-white">
                {lookbookSlides.length > 0 && (
                  <div className="space-y-4 max-w-2xl animate-fade-in">
                    <div className="inline-flex items-center gap-2 bg-[#BFA37A]/25 backdrop-blur-md border border-[#BFA37A]/40 px-3 py-1 text-[10px] tracking-[0.3em] text-[#F3EDE2] uppercase">
                      <Sparkles className="h-3 w-3 text-[#BFA37A]" />
                    ...
                    <div className="pt-6">
                      <button 
                        ...
                        className="group bg-white hover:bg-[#BFA37A] text-[#1E1D1A] hover:text-white font-medium tracking-[0.2em] text-xs py-4 px-8 rounded-none transition-all duration-300 flex items-center gap-3 uppercase shadow-lg"
                      >
                        Explorar Rituales
              ...
              {lookbookSlides.map((_, idx) => (
                <button
                  ...
                  className={`h-[3px] transition-all duration-500 rounded-none ${
                    idx === currentHeroSlide ? 'w-10 bg-[#BFA37A]' : 'w-4 bg-white/40'
                  }`}
                />
              ))}
            </div>
          ...
          <section className="bg-white py-20 border-b border-[#ECE7DC]">
            <div className="container mx-auto px-6 max-w-4xl text-center space-y-6">
              <span className="text-[11px] tracking-[0.4em] text-[#BFA37A] font-medium uppercase block">
              ...
              <div className="h-[1px] w-16 bg-[#BFA37A] mx-auto my-4" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pt-8 max-w-3xl mx-auto text-left">
                <div className="flex gap-4 items-start p-4">
                  <ShieldCheck className="h-6 w-6 text-[#BFA37A] shrink-0" />
                  <div>
                    <h4 className="font-medium text-sm tracking-wide uppercase">Cuidado Limpio</h4>
                    <p className="text-xs text-[#8A8172] font-light mt-1">Cosmética 100% orgánica certificada de alta eficacia.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start p-4">
                  <Sparkles className="h-6 w-6 text-[#BFA37A] shrink-0" />
                  <div>
                    <h4 className="font-medium text-sm tracking-wide uppercase">Diagnóstico Previo</h4>
                    <p className="text-xs text-[#8A8172] font-light mt-1">Estudio integral morfológico previo a cada servicio.</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start p-4">
                  <Clock className="h-6 w-6 text-[#BFA37A] shrink-0" />
                  <div>
                    <h4 className="font-medium text-sm tracking-wide uppercase">Atención sin Prisas</h4>
                    <p className="text-xs text-[#8A8172] font-light mt-1">Asignamos tiempo generoso para mimarte en total exclusividad.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section id="catalog-services" className="container mx-auto px-6 py-20 max-w-6xl scroll-mt-20">
            <div className="text-center mb-16 space-y-4">
              <span className="text-[11px] tracking-[0.4em] text-[#BFA37A] font-semibold uppercase block">
                Nuestra Colección
              </span>
              <h2 className="text-4xl font-serif text-foreground uppercase tracking-wider">
                Menú de Experiencias
              </h2>
              <p className="text-[#8A8172] text-sm font-light max-w-md mx-auto">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`pb-4 text-xs tracking-[0.25em] font-medium transition-all duration-300 relative rounded-none ${
                      activeTab === tab.id 
                        ? 'text-[#1E1D1A]' 
                        : 'text-[#8A8172] hover:text-[#1E1D1A]'
                    }`}
                  >
                    {tab.label}
                    {activeTab === tab.id && (
                      <span className="absolute bottom-0 left-0 right-0 h-[2px] bg-[#BFA37A] animate-fade-in" />
                    )}
                  </button>
                ))}
              </div>
            ...
            {loading && (
              <div className="text-center py-20 text-[#8A8172] font-light tracking-widest animate-pulse">
            ...
            {!loading && !error && services.length === 0 && (
              <div className="text-center py-20 text-[#8A8172] bg-white border border-[#ECE7DC] font-light max-w-lg mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {getFilteredServices().map((service) => {
                ...
                return (
                  <div 
                    key={service.id} 
                    className="bg-white border border-[#ECE7DC] transition-all duration-500 hover:border-[#BFA37A]/50 group luxury-shadow-sm hover:luxury-shadow flex flex-col justify-between"
                  >
                    {/* Visual Card Top */}
                    <div className="relative overflow-hidden aspect-[4/3] image-scale-container bg-[#FAF9F5] cursor-pointer" onClick={() => setQuickViewService(service)}>
                      <img 
                        src={service.imageUrl || '/images/hero_salon.png'} 
                        alt={service.name}
                        loading="lazy"
                        width={400}
                        height={300}
                        ...
                        onError={(e) => {
                          (e.target as HTMLImageElement).src = '/images/hero_salon.png';
                        }}
                      />
                      {/* Favorite Button */}
                      <button 
                      ...
                      >
                        <Heart className={`h-4.5 w-4.5 transition-colors ${isFav ? 'fill-[#C0392B] text-[#C0392B]' : 'text-[#8A8172]'}`} />
                      </button>
                    ...
                    <div className="p-6 space-y-4 flex-grow flex flex-col justify-between">
                      <div className="space-y-2">
                        <div className="flex justify-between items-start gap-4">
                          <h3 
                            className="text-lg font-serif text-[#1E1D1A] font-semibold group-hover:text-[#BFA37A] transition-colors cursor-pointer"
                      ...
                      <div className="pt-4 border-t border-[#FAF9F5] flex justify-between items-center">
                        <div className="flex items-center gap-1.5 text-[10px] text-[#8A8172] uppercase tracking-wider font-medium">
                          <Clock className="h-3.5 w-3.5 text-[#BFA37A]" />
                          <span>{service.duration} MIN</span>
                          <span className="text-[#ECE7DC]">|</span>
                          <div className="flex items-center text-[#BFA37A]">
                    ...
                    <div className="px-6 pb-6 pt-2 flex gap-3">
                      ...
                      <button 
                        className="flex-1 py-3 text-[10px] tracking-[0.2em] font-medium bg-[#1E1D1A] hover:bg-[#BFA37A] text-white transition-all uppercase rounded-none"
          ...
          <section className="bg-[#FAF9F5] py-20 border-t border-b border-[#ECE7DC]">
            <div className="container mx-auto px-6 max-w-6xl">
              <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
                ...
                <p className="text-xs text-[#8A8172] font-light max-w-sm">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
                {[
                  { tag: 'Rubios de Lujo', name: 'Balayage Melocotón & Oro', img: '/images/service_balayage.png' },
                  { tag: 'Corte Geométrico', name: 'Bob Esculpido con Flequillo', img: '/images/service_haircut.png' },
                  { tag: 'Dermoestética', name: 'Ritual Facial Anti-Fatiga', img: '/images/service_facial.png' },
                  { tag: 'Glow Makeup', name: 'Maquillaje de Ocasión Natural', img: '/images/service_makeup.png' }
                ].map((look, i) => (
                  <div key={i} className="relative group overflow-hidden border border-[#ECE7DC] bg-white cursor-pointer">
                    <div className="aspect-[3/4] overflow-hidden relative">
                      ...
                      <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 flex flex-col justify-end p-4">
                        <span className="text-[9px] tracking-widest text-[#BFA37A] font-semibold uppercase">{look.tag}</span>
                        <h4 className="text-white font-serif text-sm mt-1">{look.name}</h4>
                      </div>
                    </div>
                  </div>
                ))}
        ...
        <div className="container mx-auto px-6 max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-12 text-[#5C574F]">
          <div className="space-y-4">
            <span className="text-lg font-serif font-bold tracking-widest text-[#1E1D1A] uppercase">
              KAREN MENDEZ <span className="text-[#BFA37A] font-sans font-light">HAIR DESIGNER</span>
            </span>
          ...
          <div className="space-y-4">
            ...
            <div className="text-xs font-light space-y-1.5">
              <p>Lunes - Viernes: 9:00h a 20:00h</p>
              <p>Sábados: 9:00h a 14:00h</p>
          ...
          <div className="space-y-4">
            ...
            <div className="text-xs font-light space-y-1.5">
              <p>Bulevar de la Estética, 24, Planta Alta</p>
              <p>Madrid, España</p>
              <p>Tlf: +34 91 123 45 67</p>
            </div>
          </div>
        </div>
        <div className="container mx-auto px-6 max-w-6xl mt-12 pt-8 border-t border-[#FAF9F5] text-center text-[#8A8172] text-[10px] tracking-widest font-light">
            ...
            <div className="inline-block align-bottom bg-white text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-4xl sm:w-full border border-[#ECE7DC] rounded-none animate-fade-in">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div className="relative aspect-video md:aspect-auto md:h-[550px] bg-[#FAF9F5] overflow-hidden">
                  <img 
                    src={quickViewService.imageUrl || '/images/hero_salon.png'} 
                  ...
                  <div className="absolute bottom-8 left-8 right-8 text-white z-20 space-y-2">
                    <span className="text-[9px] tracking-[0.3em] text-[#BFA37A] font-bold uppercase">
                ...
                <div className="p-8 md:p-12 flex flex-col justify-between h-[550px] overflow-y-auto">
                  <div className="space-y-6">
                    <div className="flex justify-between items-end border-b border-[#ECE7DC] pb-4">
                      <div>
                        <div className="flex items-center gap-1 text-[#BFA37A] mb-1">
                          <Star className="h-3 w-3 fill-current" />
                          <Star className="h-3 w-3 fill-current" />
                          <Star className="h-3 w-3 fill-current" />
                          <Star className="h-3 w-3 fill-current" />
                          <Star className="h-3 w-3 fill-current" />
                          <span className="text-[10px] text-[#8A8172] ml-1 font-sans uppercase font-medium">5.0 (42 opiniones)</span>
                        </div>
                        <span className="text-2xl font-serif font-bold text-[#1E1D1A]">
                          ${quickViewService.price}
                        </span>
                      </div>
                      <div className="flex items-center gap-1.5 text-xs text-[#8A8172] uppercase tracking-wider font-semibold">
                        <Clock className="h-4 w-4 text-[#BFA37A]" />
                        ...
                        <div className="space-y-2.5">
                          {quickViewService.steps.map((step, stepIdx) => (
                            <div key={stepIdx} className="flex gap-3 items-start">
                              <CheckCircle2 className="h-4 w-4 text-[#BFA37A] shrink-0 mt-0.5" />
                  ...
                  <div className="pt-8 flex gap-4">
                    ...
                    <button 
                      ...
                      className="flex-1 py-4 text-xs tracking-[0.2em] font-semibold bg-[#1E1D1A] hover:bg-[#BFA37A] text-white transition-all uppercase rounded-none shadow-lg"
                    >
                      Reservar Ahora
                    </button>
                  </div>
